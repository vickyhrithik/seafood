...
import newpatientinformationStyle from "./NewPatientInformation.Style"
import {Colors} from "../../util/Color"

const numberOfRows = 3
export default class NewPatientInformationScreen extends React.Component {
    constructor(props) {
      super(props);
    ...
    _navigateToContinue = () => {
      ...
      this.props.navigation.navigate("VerifyYourNumber");
