...
export default class HistoryThirdScreen extends Component {
  constructor(props){
    super(props)
             ...
             <View style={historyStyle.dctprofileView}>
...

                {
                  medicinesdata.map((item,index) =>{
                    ...
                    <Text style={historyStyle.cancelled}>{Strings.HISTORYTEXT.CANCELLED}</Text>
                    <Text style={historyStyle.cancelledcontent}>{Strings.HISTORYTEXT.CANCELLEDCONTENT}</Text>
                    <View style={historyStyle.historyThirdlineborders}/>
               <Text style={historyStyle.cancellationText} >{Strings.HISTORYTEXT.CANCELLATION}</Text>
